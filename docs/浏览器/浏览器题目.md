...
[IndexedDB 与 LocalStorage 和 SessionStorage 的比较](https://blog.openreplay.com/zh/indexeddb-localstorage-sessionstorage/)
​
- localStorage：
...
- IndexedDB：
  - 存储容量：通常支持更大的存储容量，现代浏览器通常允许使用磁盘剩余空间的 50% 左右，可达数 GB，具体容量因浏览器而异。
